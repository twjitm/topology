...
public class NBodyForce extends AbstractForce {
     ...
     * item mass values.θ巴尼斯小屋参数θ，它控制的时一个聚合的质量，而不是钻到个人项目质量值。
     */
     ...
     * 用提供的封闭仿真初始化仿真。打这之后了，仿真可以查询作用在给定项目的体力。
    ...
    /**
     * Inserts an item into the quadtree.将项插入到树
    ...
    /**
     * Helper class to minimize number of object creations across multiple以尽量减少在多个对象创建的数量
