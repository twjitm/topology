...
public class GraphMLReader extends AbstractGraphReader  implements GraphReader {
	...
	public static class GraphMLHandler extends DefaultHandler implements Tokens
	{
		...
		//边长度
		public static final String LENGHT = Graph.LENGHT;
		public static final String LENGHTID = LENGHT + '_' + ID;
		...
		public void startDocument() {
			...
			m_esch.addColumn(LENGHT, String.class);//边长度相关
			m_esch.addColumn(LENGHTID, String.class);
		}
				...
				String qName, Attributes atts)
		{
			...
			else if ( qName.equals(EDGE) )
			{
				...
				m_edges.setString(m_row, LENGHT, atts.getValue(LENGHT));
				m_edges.setString(m_row, LENGHTID, atts.getValue(LENGHTID));
