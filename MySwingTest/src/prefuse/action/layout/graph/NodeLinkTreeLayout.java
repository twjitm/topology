...
public class NodeLinkTreeLayout extends TreeLayout {
    ...
    private int    m_orientation;  // the orientation of the tree树走向
    private double m_bspace = 1;   // the spacing between sibling nodes节点之间的间距
    private double m_tspace = 25;  // the spacing between subtrees子树之间的间距
    private double m_dspace = 50;  // the spacing between depth levels深度层次之间的间距
    ...
    /**
     * Set the spacing between depth levels.设置深度级别之间的间距
    ...
    /**
     * Set the spacing between neighbor nodes.设置邻居节点之间的间距。
    ...
    /**
     * Set the spacing between neighboring subtrees.相邻子树设置间距。
     ...
     * bounds.
     * 设置用于放置树的根节点的偏移值。此偏移量的大小取决于树的方向。
     * 例如，在左到右的方向上，偏移将从布局边界的左边缘偏移一个水平偏移量。
    ...
    private double spacing(NodeItem l, NodeItem r, boolean siblings) {
        ...
        return (siblings ? m_bspace : m_tspace) + 1 *
